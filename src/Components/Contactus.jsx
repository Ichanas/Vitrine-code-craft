...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "fd6de72c-c24e-4e30-b60a-6198e87c6970"); // ⚠️ Mets ta vraie clé ici
  ...
  return (
    <div
      id="contact"
      className="bg-black min-h-screen flex flex-col items-center py-12 px-4"
    >
      <h2 className="text-yellow-400 text-4xl md:text-5xl font-bold text-center mb-4">
        Contactez-nous
      </h2>
      <p className="text-gray-200 text-center mb-10 max-w-2xl">
        Prêt à transformer votre vision en réalité numérique ? Discutons de
        votre projet.
      </p>
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <form
          onSubmit={onSubmit}
          className="bg-[#181c27] rounded-xl p-6 md:col-span-1 shadow-lg flex flex-col gap-4 border border-gray-700"
        >
          ...
          {result && (
            <p className="text-sm text-center text-gray-300 mt-2">{result}</p>
          )}
        </form>
