...
const Home = () => {
  return (
    <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      {/* Header */}
        <header className="relative z-10 flex items-center justify-between px-6 py-4 md:px-16 backdrop-blur-lg bg-black/60 rounded-b-xl">
            <div className="flex items-center gap-2">
                <span className="bg-yellow-400 rounded-full p-2">
                {/* Logo identique au footer */}
...
<main className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] px-4 text-center">
  <h1 className="text-yellow-400 text-5xl md:text-7xl font-bold mb-6">Code Craft</h1>
  <p className="text-white text-lg md:text-2xl max-w-2xl mb-8 mx-auto">
    Excellence en développement et digitalisation. Nous transformons vos idées en solutions numériques haut de gamme.
  </p>
  ...
  <div className="mt-16">
    <span className="text-yellow-400 animate-bounce text-3xl">&#8595;</span>
  </div>
</main>
    </div>
  );
